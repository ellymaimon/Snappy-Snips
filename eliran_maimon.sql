...
--
-- Database: `eliran_maimon`
--
CREATE DATABASE IF NOT EXISTS `eliran_maimon` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `eliran_maimon`;
...
INSERT INTO `Clients` (`ClientId`, `ClientFirstName`, `ClientLastName`) VALUES
(14, 'Eliran', 'Maimon');
...
INSERT INTO `Specialties` (`SpecialtyId`, `Description`) VALUES
(6, 'Balayage'),
(7, 'Barbering');
...
--
-- Dumping data for table `StylistClients`
--

INSERT INTO `StylistClients` (`StylistClientId`, `ClientId`, `StylistId`) VALUES
(22, 14, 24);
...
INSERT INTO `Stylists` (`StylistId`, `StylistFirstName`, `StylistLastName`) VALUES
(24, 'Stephanie', 'Baroni');
...
INSERT INTO `StylistSpecialties` (`StylistSpecialtyId`, `SpecialtyId`, `StylistId`) VALUES
(17, 6, 24),
(18, 7, 24);
...
--
ALTER TABLE `Specialties`
  MODIFY `SpecialtyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `StylistClients`
--
ALTER TABLE `StylistClients`
  MODIFY `StylistClientId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `Stylists`
--
ALTER TABLE `Stylists`
  MODIFY `StylistId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `StylistSpecialties`
--
ALTER TABLE `StylistSpecialties`
  MODIFY `StylistSpecialtyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
